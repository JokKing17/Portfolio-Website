      ...
      <div className="relative flex h-full min-h-[520px] flex-col overflow-hidden rounded-[15px] border border-white/[0.14] bg-[rgba(13,18,27,0.92)] shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_24px_70px_rgba(0,0,0,0.28)] backdrop-blur-md transition duration-300 group-hover:border-primary/35 group-hover:bg-[rgba(16,23,33,0.94)]">
        ...
        <div className="flex flex-1 flex-col p-5 pt-6 sm:p-6">
            ...
            <div className="relative z-20 flex shrink-0 items-center gap-2">
              {project.githubUrl ? (
                <a
                  ...
                  className="grid size-9 place-items-center rounded-full border border-white/[0.14] bg-white/[0.07] text-muted-foreground shadow-[0_8px_24px_rgba(0,0,0,0.18)] transition duration-300 hover:-translate-y-0.5 hover:border-primary/45 hover:bg-primary/[0.12] hover:text-primary"
          ...
          {project.shortDescription ? (
            <p className="mt-5 line-clamp-3 min-h-[4.75rem] text-sm leading-7 text-muted-foreground">
              {project.shortDescription}
            </p>
          ) : null}
          ...
          {visibleTech.length ? (
            <div className="mt-auto flex flex-wrap gap-2 pt-6">
              ...
              {hiddenTechCount ? (
                <Badge className="rounded-full border-primary/25 bg-primary/[0.12] px-3 py-1.5 text-[11px] text-primary">
